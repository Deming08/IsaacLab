...
gym.register(
    id="Isaac-Velocity-Flat-Turtlebot3-v0",
...
gym.register(
    id="Isaac-Velocity-Flat-Turtlebot3-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Velocity-Rough-Turtlebot3-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Velocity-Rough-Turtlebot3-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
