...
@configclass
class CubeStackG1MimicEnvCfg(CubeStackG1EnvCfg, MimicEnvCfg):
    ...
    def __post_init__(self):
        ...
        subtask_configs.append(
            SubTaskConfig(
                ...
                # If True, apply action noise during the interpolation phase and execution
                apply_noise_during_interpolation=False,
                next_subtask_description="Grasp blue cube",
            )
        )
        subtask_configs.append(
            SubTaskConfig(
                ...
                # If True, apply action noise during the interpolation phase and execution
                apply_noise_during_interpolation=False,
                next_subtask_description="Stack blue cube on top of green cube",
            )
        )
        subtask_configs.append(
            SubTaskConfig(
