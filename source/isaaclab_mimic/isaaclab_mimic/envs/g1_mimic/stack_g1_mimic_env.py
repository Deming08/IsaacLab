...
class CubeStackG1MimicEnv(ManagerBasedRLMimicEnv):
    ...
    def get_subtask_term_signals(self, env_ids: Sequence[int] | None = None) -> dict[str, torch.Tensor]:
        ...
        #signals["idle_left"] = torch.ones_like(signals["grasp_1"], dtype=torch.bool)  # Always true
        
        # final subtask is placing cube_3 on cube_1 (motion relative to cube_1) - but final subtask signal is not needed
        return signals
