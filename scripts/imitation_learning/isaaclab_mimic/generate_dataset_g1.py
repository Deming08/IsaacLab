...
parser.add_argument("--input_file", type=str, default="./datasets/dataset_annotated.hdf5", help="File path to the source dataset file.")
parser.add_argument(
    "--output_file",
    type=str,
    default="./datasets/generated_g1_dataset.hdf5",
...
import isaaclab_mimic.envs.g1_mimic  # noqa: F401
